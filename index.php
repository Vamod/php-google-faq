         ...
         <header>
             ...
             <div class="header-bottom">
                <div class="navbar">
                    ...
                    <div class="user">
                        <div class="user-img">
                            <img src="https://icon-library.com/images/google-user-icon/google-user-icon-7.jpg" alt="user-img">
                        </div>
                        <div class="user-mail">francesco.totti@gmail.com</div>
                    </div>
                </div>
             </div>
         </header>
             ...
             <div class="container">
                <?php
                    foreach ($faqs as $key => $faq){ ?>
                        <h2 class="faq-title"><?php echo $faq['title']; ?> </h2>
                        <p class="faq-body"><?php echo $faq['body']; ?> </p>
                <?php } ?>
             </div>
         </main>
         <footer>
